...
Screenshots can be found in `screenshots` directory to demonstrate that the app is functional.

## Create Payment

Create a new payment. ID is generated by the app and assigned.

<img src="screenshots/1_CreatePayment.png" />

## Get Payment

Get payment by ID

<img src="screenshots/2_GetPayment.png" />

## List Payments

Listing all payments in the table

<img src="screenshots/3_ListPayments.png" />

When currency is passed as a query param,

<img src="screenshots/4_ListPaymentsWithCurrencyFilter.png" />
